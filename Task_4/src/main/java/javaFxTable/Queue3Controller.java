...
public class Queue3Controller implements Initializable {
    public Label lable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableview.setItems(Main.queue3.getPassenger());

        FilteredList<Passenger> filteredData = new FilteredList<>(Main.queue3.getPassenger(), b -> true);
