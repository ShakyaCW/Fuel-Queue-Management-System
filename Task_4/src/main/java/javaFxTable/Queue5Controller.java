...
public class Queue5Controller implements Initializable {
    public Label lable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableview.setItems(Main.queue5.getPassenger());

        FilteredList<Passenger> filteredData = new FilteredList<>(Main.queue5.getPassenger(), b -> true);
