...
public class Queue4Controller implements Initializable {
    public Label lable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableview.setItems(Main.queue4.getPassenger());

        FilteredList<Passenger> filteredData = new FilteredList<>(Main.queue4.getPassenger(), b -> true);
