...
public class Queue2Controller implements Initializable {
    public Label lable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableview.setItems(Main.queue2.getPassenger());

        FilteredList<Passenger> filteredData = new FilteredList<>(Main.queue2.getPassenger(), b -> true);
